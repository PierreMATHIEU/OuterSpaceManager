...
public class SqlDatabase extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "MyDBAttack.db";
    ...
    private static final String ATTACK_TABLE_CREATE = "CREATE TABLE " + ATTACK_TABLE_NAME + " (" + KEY_TIME + " REAL, " + KEY_FLEET + " TEXT);";
